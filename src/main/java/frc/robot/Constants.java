...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kLeftElevatorCanId = 19;
    public static final int kRightElevatorCanId = 18;

    //Victor Can ids
    
    //These cans are for the elevator
    public static final int kWristCanId = 2; //we will use this for the arm's wrist joint up down thing
    public static final int kLeftCoralSpinnerCanId = 3; //this will spin the coral
    public static final int kRightCoralSpinnerCanId = 4;

    public static final int kLeftAlgaeSpinnerCanId = 5; // this will spin blue ball
    public static final int kRightAlgaeSpinnerCanId = 6;
